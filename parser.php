...
array_filter($result, function($val) use($conn, $uid,  $datetime, $hdmi )
{
    ...
    switch(strval( substr($val , 0, 2)))
    {
        ...
        case DOOR_TYPE:
            ...
            $stmt->execute( [$uid, strval( DOOR_TYPE), strval( hexdec($dt[1])) , strval($crc) , $datetime, $_SESSION['ip'], $_SESSION['mac'], $hdmi ] );
            unset($stmt);
        ...
        case WATER_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval(WATER_TYPE), strval( hexdec($dt[1])) , strval($crc) , $datetime ,$_SESSION['ip'], $_SESSION['mac'] , $hdmi] );
            unset($stmt);
        ...
        case LIGHT_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
			$stmt->execute( [$uid, strval( LIGHT_TYPE),  strval( hexdec($cols)) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi ] );
            unset($stmt);
        ...
        case TEMP_HUMIDITY_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval( TEMP_HUMIDITY_TYPE), strval(hexdec($cols)) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi ] );
            unset($stmt);
        ...
        case G_SENSOR_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval( G_SENSOR_TYPE), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'] , $hdmi] );
            unset($stmt);
        ...
        case GPIO_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval( GPIO_TYPE), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi] );
            unset($stmt);
        ...
        case RELAY_TYPE:
            ...
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval( RELAY_TYPE), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi] );
            unset($stmt);
        ...
        case VOLTAGE_TYPE:
            ...
            $cols = $arr[1];
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval(hexdec(VOLTAGE_TYPE)), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'],$_SESSION['mac'], $hdmi] ) ;
            unset($stmt);           
            sleep(1);
        ...
        case ELECTRIC_METER_TYPE:
            ...
            $cols ='6';
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval(hexdec(ELECTRIC_METER_TYPE)), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi] ) ;
            unset($stmt);
            sleep(1);
            for($i = 0; $i< sizeof($arr); $i++)
            {
        ...
        case EXT_RAP_TYPE:
            ...
            $cols = $arr[1];
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval(hexdec(EXT_RAP_TYPE)), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi] ) ;
            unset($stmt);           
            sleep(1);
            for($i = 0; $i< sizeof($arr); $i++)
            {
        ...
        case RTC_TYPE:
            ...
            $cols = $arr[1];
            $stmt  = $conn -> prepare("INSERT INTO  parseddatasets (uid, tipo, qtde_colunas, crc, datahora, rmc_ip, rmc_mac, hdmistatus) VALUES ( ? , ? , ? , ? , ?  , ?  , ? , ?  )");
            $stmt->execute( [$uid, strval(hexdec(RTC_TYPE)), strval($cols) , strval($crc) , $datetime , $_SESSION['ip'], $_SESSION['mac'], $hdmi] ) ;
            unset($stmt);           
            sleep(1);
            for($i = 0; $i< sizeof($arr); $i++)
            {
